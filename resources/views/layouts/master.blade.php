    ...
    <div class="carousel-inner">
        <div class="item active">
            ...
            <div class="carousel-caption">
                <h1 class="wow animated slideInDown">高铁列车专用的<span class="highlight">订餐应用</span></h1>
                <p class="intro-text wow animated slideInUp">欢迎使用高铁列车订餐系统，享受移动互联网时代，在线精选套餐，多样选择，立即送达</p>
